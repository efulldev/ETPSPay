package com.efulltech.epay_tps_library_module.misc;
 ...
 * questions.
 */
public final class ATRParser implements java.io.Serializable {
     ...
     */
    public ATRParser(byte[] atr) {
        this.atr = atr.clone();
        parse();
    }

    public ATRParser(String string){
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ATRParser == false) {
            return false;
        }
        ATRParser other = (ATRParser) obj;
