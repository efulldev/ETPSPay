...
public enum FIELDS {
    ...
    private static Map<Integer, com.efulltech.efull_nibss_bridge.epms.packager.ISO8583.enums.FIELDS> map = new HashMap<Integer, com.efulltech.efull_nibss_bridge.epms.packager.ISO8583.enums.FIELDS>();

    static {
        for (com.efulltech.efull_nibss_bridge.epms.packager.ISO8583.enums.FIELDS field : com.efulltech.efull_nibss_bridge.epms.packager.ISO8583.enums.FIELDS.values()) {
    ...
    public static com.efulltech.efull_nibss_bridge.epms.packager.ISO8583.enums.FIELDS valueOf(int no) {
        return map.get(no);
    }
}
