...
import com.efulltech.efull_nibss_bridge.TelpoBaseApplication;
...
public class DeviceManager {
     ...
     */
    private UDeviceManager deviceManager = TelpoBaseApplication.getDeviceService().getDeviceManager();

    /**
     * Context.
     */
    private Context context = TelpoBaseApplication.getContext();
