...
import com.efulltech.efull_nibss_bridge.epms.util.DeviceService;
...
public class TelpoBaseApplication extends Application {

    private static final String TAG = "TelpoBaseApplication";
